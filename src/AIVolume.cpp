...
void AIVolume::Spawn()
{
    ...
    strcpy(ocs.m_Filenames[0], "Models/AI/AI_M-MOTION-FOOL.LTB");
    strcpy(ocs.m_SkinNames[0], "ModelTextures/AI/NANO_FOOL/NANO_FOOL_BODY.DTX");
    strcpy(ocs.m_SkinNames[1], "ModelTextures/AI/NANO_FOOL/NANO_FOOL_FACE.DTX");

    LTFLOAT x = g_pLTServer->Random(-m_vDims.x, m_vDims.x);
    LTFLOAT z = g_pLTServer->Random(-m_vDims.z, m_vDims.z);

    //LTVector vPos(300.0f, -5083.90f, -300.55f);
